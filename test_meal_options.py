...
class AppApiTestCase(unittest.TestCase):
    ...
    def test_get_meal_options(self):
        ...
        response = self.client.get('/v1/meals/4', data = json.dumps(self.data), content_type = 'application/json')
    ...
    def test_delete_meal(self):
        response = self.client.post('v1/meal', data=json.dumps(self.data))
        self.assertEqual(response.status_code,201)
        del_response = self.app.delete('/v1/meal/2', data=json.dumps(self.data), content_type = 'application/json')
    ...
    def test_get_menu(self):
        self.app = app.test_client()
        response = self.app.get('/v1/menu', data = json.dumps(self.data), content_type = 'application/json')
